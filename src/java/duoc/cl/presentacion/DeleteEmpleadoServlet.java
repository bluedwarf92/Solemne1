 ...
 * @author Cami
 */
@WebServlet(name = "DeleteEmpleadoServlet", urlPatterns = {"/deleteEmpleado"})
public class DeleteEmpleadoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objEmpleadoBO.deleteEmpleado(id)) {
            sesion.setAttribute("exitoIngresoEmpleado", "Empleado correctamente eliminado!");
            response.sendRedirect("MantenedorEmpleados.jsp");
        } else {
            sesion.setAttribute("error", "no se pudo eliminar el empleado");
            response.sendRedirect("MantenedorEmpleados.jsp");
        }
    }

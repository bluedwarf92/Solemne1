...
public class ObraDAO implements ICRUD {
    ...
    public boolean addElemento(Object objetoInsert) {
        ...
        try {
            ...
            String query = "INSERT INTO obra(id_tipo_obra,direccion,id_comuna,valor_hora,fecha_inicio,fecha_fin) VALUES(?,?,?,?,?,?);";
    ...
    public List readElementos() {
        ...
        try {
            ...
            while (rs.next()) {
                Obra objObra = new Obra(rs.getInt(1), rs.getInt(2), rs.getString(3), rs.getInt(4), rs.getInt(5), rs.getDate(6), rs.getDate(7));
    ...
    public boolean updateElemento(Object objetoUpdate) {
        ...
        try {
            Connection con = Conexion.getConexion();
            String query = "UPDATE obra SET id_tipo_obra = ?, direccion = ?, id_comuna = ?, valor_hora = ?, fecha_inicio = ?, fecha_fin = ? WHERE id_obra = ?;";
            PreparedStatement ps = con.prepareStatement(query);
            ps.setInt(1, objObra.getId_tipo_obra());
            ps.setString(2, objObra.getDireccion());
            ps.setInt(3, objObra.getId_comuna());
            ...
            ps.setDate(5, objObra.getFecha_inicio());
            ps.setDate(6, objObra.getFecha_fin());
            ps.setInt(7, objObra.getId_obra());

            ...
            <c:when test="${usuarioConectado!=null}">
                ...
                <div class="container">
                    <div class="jumbotron">
                        ...
                        <p>Este mantenedor te permite modificar y agregar Empleados, incluyendo sus caracteristicas y sus privilegios.</p>
                        ...
                        <div class="form-horizontal">
                            <form class="form-inline" method="GET">
                                <div class="form-group">
                                    <label class="sr-only" for="txtBuscarEmpleado">Nombre Empleado</label>
                                    <input type="text" class="form-control" id="txtBuscarEmpleado" name="txtBuscarEmpleado" placeholder="Nombre Empleado">
                                </div>                                    
                                <button  type="submit" class="btn btn-default" >Buscar por Empleado &nbsp;<span class="glyphicon glyphicon-search"></span></button>
                            </form>
                        </div>
                        <%-- Fin Buscador--%>
                        <br>
